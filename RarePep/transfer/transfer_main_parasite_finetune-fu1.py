...
from configs_parasite2 import get_cfg_defaults
...
def main():
    ...
    best_epoch = [164,177,182,157,125]
    ...
    # for seed in aa:
        ...
        torch.load(f"/home/zhouxiaoping/jianmoxing/DrugBAN-main/DrugBAN-main/result/text-transfer/fungi+virus-parasite/{seed}/best_model_epoch_{current_epoch}.pth"))
