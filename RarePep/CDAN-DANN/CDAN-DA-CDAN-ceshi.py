...
from configs_MMD_ce import get_cfg_defaults
from dataloader import DTIDataset, MultiDataLoader
from torch.utils.data import DataLoader
from DA_trainer_ce import Trainer
...
parser.add_argument('--cfg', type=str, default='./configs/DrugBAN_DA1.yaml', help="path to config file")
...
def main():
    ...
    for seed in aa:
        ...
        dataFolder = f'/mnt/402f169c-136d-4c4c-b598-a9732ee96752/home/zxp/zhouxiaoping/kuayu/Bacteria-virus'
