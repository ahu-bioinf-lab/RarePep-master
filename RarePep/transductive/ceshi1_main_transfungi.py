...
def main():
    ...
    for seed, current_epoch in zip(aa, best_epoch):
        ...
        if not cfg.DA.TASK:
            train_path = os.path.join(dataFolder, str(seed), 'B+F+V.xlsx')
        ...
        #     torch.load(
        #         f"/home/zhouxiaoping/jianmoxing/DrugBAN-main/DrugBAN-main/result/text-transfer/bacteria+fungi-parasite/{seed}/best_model_epoch_{current_epoch}.pth"))
