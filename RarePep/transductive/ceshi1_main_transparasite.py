...
def main():
    ...
    # for seed in aa:
        ...
        if not cfg.DA.TASK:
            train_path = os.path.join(dataFolder, str(seed), 'B+F.xlsx')
        ...
        # torch.load(f"/home/zhouxiaoping/jianmoxing/DrugBAN-main/DrugBAN-main/result/text-transfer/bacteria+virus-parasite/{seed}/best_model_epoch_{current_epoch}.pth"))
